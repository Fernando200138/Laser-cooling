...
import sys
import os 
#sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '/ferna\Documentos\Internship\Internship_programs\laser_cooling-rep3\laser_cooling-main\model')))
